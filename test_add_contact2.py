...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, first_name="Annaa", middle_name="Maria", last_name="Ivanova", nickname="marie", title="ree", company="test_company", address="trtrtrt", home="64645",
    ...
    def create_contact(self, wd, first_name, middle_name, last_name, nickname, title, company, address, home, mobile,
                       work, fax, email, email_2, homepage, b_year, address_2, notes):
        # fill contact form
        ...
        wd.find_element_by_name("phone2").send_keys(notes)
